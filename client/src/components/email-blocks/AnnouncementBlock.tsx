...
export default function AnnouncementBlock({ id, content, isEditing, onDelete, onUpdate }: AnnouncementBlockProps) {
  return (
    <div className="group relative">
      {isEditing && (
        <div className="absolute -left-10 top-2 flex flex-col gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
          <Button size="icon" variant="ghost" className="h-6 w-6 cursor-grab" data-testid={`drag-announcement-${id}`}>
